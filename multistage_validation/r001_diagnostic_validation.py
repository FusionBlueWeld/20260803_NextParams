"""Validate learned r001 composition, NG diagnosis, and connected recovery.

Known fault labels are used only after diagnosis to score the result.  The
diagnostic itself sees the expected recipe, the observed recipe, and learned
stage-bundle predictions.
"""
...
from multistage_validation.functional_coating.coating import physics_model as coating_oracle
from multistage_validation.functional_coating.curing import physics_model as curing_oracle
from multistage_validation.functional_coating.drying import physics_model as drying_oracle
from multistage_validation.functional_coating.fault_scenarios import FAULT_SCENARIOS, REFERENCE_NOMINAL
...
REPORT_PATH = ROOT / "multistage_validation/results/r001_diagnostic_validation.json"
STAGE_CONTROL_NAMES = {
