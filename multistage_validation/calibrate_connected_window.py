"""Fit connected residual intervals on an oracle calibration split.

This is an oracle benchmark utility.  Calibration and final boundary evaluation
use different seeds and the resulting file is tied to exact predictor hashes.
"""
...
from multistage_validation.r001_diagnostic_validation import _lhs, _load_runtime
