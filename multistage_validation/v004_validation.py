...
from multistage_validation.functional_coating.coating.physics_model import evaluate_model
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        raise SystemExit("usage: python -m multistage_validation.v004_validation TRIAL REPORT.json")
