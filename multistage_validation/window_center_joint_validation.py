"""Independent oracle validation for window-center selection and joint changes."""
...
from multistage_validation.calibrate_connected_window import _truth_feasible
from multistage_validation.connected_window_validation import _oracle_process_feasible
from multistage_validation.functional_coating.pipeline import LINE_INPUT_BOUNDS, evaluate_line
...
REPORT = ROOT / "multistage_validation/results/window_center_joint_validation.json"
