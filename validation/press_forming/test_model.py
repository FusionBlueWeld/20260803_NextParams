...
except ImportError:  # Support ``python validation/press_forming/test_model.py``.
    sys.path.insert(0, str(Path(__file__).resolve().parents[2]))
    from validation.press_forming.physics_model import evaluate_model
...
class PressFormingModelTest(unittest.TestCase):
    ...
    def test_real_registry_load_audit_and_individual_constraint_violations(self) -> None:
        ...
        from validation.benchmark import audit
