...
NN_RESPONSE_FILE_PREFIX = "nn_response_space_run_"
...
# NNはGPとは独立に、同じ実験データから予測空間を作ります。
# 少数データ時の不安定な形状も観察対象なので、データ件数による停止はしません。
NN_SEED = 42
NN_HIDDEN_SIZE = 32
NN_MAX_EPOCHS = 2_000
...
def trial_path(trial_name: str) -> Path:
    """trial名から、v001内のtrialフォルダを組み立てます。"""
