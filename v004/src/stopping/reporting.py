...
def build_stop_context(experiments, *, problem, knowledge_rules, region_policy, stop_config, connection=None):
    ...
    return {
        "settings_fingerprint": _fingerprint({
            ...
            "stage_connection": None if connection is None else asdict(connection),
        }),
