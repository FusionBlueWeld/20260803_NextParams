...
from src.connection import (
    ...
    current_context_observation_mask,
    fixed_context_grid,
    load_stage_connection,
)
...
def prepare_trial(trial_name: str) -> None:
    ...
    connection = load_stage_connection(current_trial / CONNECTION_FILE_NAME, problem)
...
def run_trial(trial_name: str, recommendation_count: int) -> None:
    ...
    if connection is not None:
        from src.stage_bundle import export_stage_bundle
